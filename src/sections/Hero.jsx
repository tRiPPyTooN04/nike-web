...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10  py-2 max-container "
    >
      <div
      ...
      >
        ...
        <h1
          className="mt-10 font-palanquin text-8xl  text-slate-gray max-sm:text-[72px]
